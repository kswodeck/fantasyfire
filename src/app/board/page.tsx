...
export const metadata: Metadata = {
  ...
  description:
    'The strongest recent-form player-prop reads across every in-season league — NBA, MLB, and NFL — merged into one board and ranked by our sample-size-adjusted FireFactor. Switch books or pick a single sport. Research, not picks.',
