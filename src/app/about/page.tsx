...
export const metadata: Metadata = {
  title: 'About',
  description: `What ${SITE.name} is: matchup-adjusted projections and +EV for NBA, WNBA, MLB, NFL, NHL, and MLS player props, priced against the market and shown with their uncertainty.`,
...
export default function AboutPage() {
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8">
      ...
      <Prose>
        <p>
          {SITE.name}{' '}is a projection and +EV research tool for NBA, WNBA, MLB, NFL, NHL, and MLS player
        ...
        <p>
          Projections are computed from publicly available NBA, WNBA, MLB, NFL, NHL, and MLS game logs, refreshed
          ...
          is not affiliated with or endorsed by the NBA, WNBA, MLB, NFL, NHL, MLS, any team, or any sportsbook;
