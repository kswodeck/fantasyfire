    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-8">
      ...
      <Prose>
        ...
        <p>
          ...
          NBA, WNBA, MLB, NFL, NHL, Premier League, and MLS data. It is for informational and entertainment purposes only and is{' '}
        ...
        <p>
          ...
          sponsored by the NBA, WNBA, MLB, NFL, NHL, Premier League, MLS, or any team. League and team names, logos, and player
