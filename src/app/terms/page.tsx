    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-8">
      ...
      <Prose>
        ...
        <p>
          ...
          NBA, WNBA, MLB, NFL, NHL, MLS, CFB, and CBB data. It is for informational and entertainment purposes only and is{' '}
        ...
        <p>
          ...
          sponsored by the NBA, WNBA, MLB, NFL, NHL, MLS, the NCAA, or any team or school. League and team names, logos, and player
