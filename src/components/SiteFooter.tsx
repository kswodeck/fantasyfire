      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-xs leading-relaxed text-muted">
              Honest player-prop research, built on public game logs across six leagues.
            </p>
            <a
        ...
        <div className="mt-8 space-y-2 border-t border-line pt-6 text-xs leading-relaxed text-muted">
          <p>
            ...
            built on public NBA, WNBA, MLB, NFL, NHL, and MLS game logs. Hit rates and matchup numbers are
          ...
          <p>
            Not affiliated with or endorsed by the NBA, WNBA, MLB, NFL, NHL, MLS, or any team. © {year}{' '}
            {SITE.name}.
          </p>
        </div>
      </div>
