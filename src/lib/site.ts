...
export const SITE = {
  ...
  description:
    "NBA, WNBA, MLB, NFL, NHL, Premier League, and MLS player-prop research that's honest about uncertainty: hit rates over recent windows and the full season, matchup context, sample-size confidence intervals, and fair-price math — from public game logs.",
